...
class ShieldInjectorModule(moduleItem.ModuleItem):
    ...
    def __init__(self, name : str, aliases : List[str], plasmaConsumption : int = 0, value : int = 0,
        ...
        """
        super(ShieldInjectorModule, self).__init__(name, aliases, value=value, wiki=wiki, manufacturer=manufacturer, icon=icon,
    ...
    def fromDict(cls, moduleDict : dict, **kwargs):
        ...
        return ShieldInjectorModule(**cls._makeDefaults(moduleDict,
