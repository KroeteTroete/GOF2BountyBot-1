...
class EmergencySystemModule(moduleItem.ModuleItem):
    ...
    def statsStringShort(self):
        return "*Duration: " + lib.stringTyping.formatAdditive(self.duration) + "s*"
    ...
    def fromDict(cls, moduleDict : dict, **kwargs):
        ...
        return EmergencySystemModule(moduleDict["name"], moduleDict["aliases"] if "aliases" in moduleDict else [],
                                        ...
                                        emoji=lib.emojis.BasedEmoji.fromStr(moduleDict["emoji"]) if "emoji" in moduleDict \
                                                else lib.emojis.BasedEmoji.EMPTY,
