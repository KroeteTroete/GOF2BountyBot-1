...
class RepairBotModule(moduleItem.ModuleItem):
    ...
    def __init__(self, name : str, aliases : List[str], HPps : float = 0, value : int = 0,
        ...
        """
        super(RepairBotModule, self).__init__(name, aliases, value=value, wiki=wiki, manufacturer=manufacturer, icon=icon,
    ...
    def fromDict(cls, moduleDict : dict, **kwargs):
        ...
        return RepairBotModule(**cls._makeDefaults(moduleDict,
