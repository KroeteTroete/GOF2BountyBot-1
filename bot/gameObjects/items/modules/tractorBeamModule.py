...
class TractorBeamModule(moduleItem.ModuleItem):
    ...
    def __init__(self, name : str, aliases : List[str], timeToLock : float = 0, value : int = 0,
        ...
        :param float timeToLock: The amount of time in seconds needed for the beam to lock onto
                                    an item and pull it into the hold (Default 0)
        ...
        """
        super(TractorBeamModule, self).__init__(name, aliases, value=value, wiki=wiki, manufacturer=manufacturer, icon=icon,
    ...
    def fromDict(cls, moduleDict : dict, **kwargs):
        ...
        return TractorBeamModule(**cls._makeDefaults(moduleDict,
