...
class ThrusterModule(moduleItem.ModuleItem):
    ...
    def __init__(self, name : str, aliases : List[str], handlingMultiplier : float = 1, value : int = 0,
        ...
        """
        super(ThrusterModule, self).__init__(name, aliases, handlingMultiplier=handlingMultiplier, value=value, wiki=wiki,
    ...
    def fromDict(cls, moduleDict : dict, **kwargs):
        ...
        return ThrusterModule(moduleDict["name"], moduleDict["aliases"] if "aliases" in moduleDict else [],
                                handlingMultiplier=moduleDict["handlingMultiplier"] if "handlingMultiplier" \
                                                    in moduleDict else 1,
