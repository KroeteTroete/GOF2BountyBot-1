...
class PrimaryWeapon(gameItem):
    ...
    def __init__(self, name : str, aliases : List[str], dps : float = 0.0, value : int = 0,
        ...
        :param bool builtIn: Whether this is a BountyBot standard weapon (loaded in from bbData) or a custom 
                                spawned weapon (Default False)
        """
        super(PrimaryWeapon, self).__init__(name, aliases, value=value, wiki=wiki, manufacturer=manufacturer, icon=icon,
