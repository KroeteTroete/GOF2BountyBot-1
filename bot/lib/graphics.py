...
def progressBar(w: int, h: int, progress: float, mode: str = "L", bgColour: int = 0x000000, barColour: int = 0xffffff) -> Image.Image:
    """Create a simple progress bar with a black background. Background fills the image, not limited to the bar shape.
    The default image mode is "L" - intended to be used for creating image masks.
    ...
    :param str mode: The image mode (Default L)
